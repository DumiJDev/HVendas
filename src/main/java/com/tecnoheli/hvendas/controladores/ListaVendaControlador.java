...
public class ListaVendaControlador implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        final Label[] labels = {new Label("Cliente"), new Label("Funcionário"),
    ...
    private Parent novoItem(Label...lbs) throws IOException {
        Label[] lb = {new Label("Maria David"), new Label("Paulo Paulo"),
                new Label("02/06/2021"), new Label("200.000,00 Akz")};
